...
const QuickSelectTaskButton = ({ record, recordd, ...props }) => {
  ...
  return (
    <>
      ...
      <Dialog fullWidth open={showPanel} onClose={toggleDrawer}>
        <TaskList style={{width: '800px'}} {...props} resource="PMWorks/TaskTemp" setShowPanel={setShowPanel} data={record} dataa={recordd}/>
      </Dialog>
    </>
  );
};
