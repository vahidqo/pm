...
const QuickLocationSelectButton = ({ id, setId, ...props }) => {
  ...
  return (
    <>
      ...
      <Dialog fullWidth open={showPanel} onClose={toggleDrawer}>
        <LocationList style={{width: '780px'}} {...props} resource="PMWorks/Location" setId={setId} setShowPanel={setShowPanel} />
      </Dialog>
    </>
  );
};

export default QuickLocationSelectButton;