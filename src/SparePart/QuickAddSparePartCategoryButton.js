...
function QuickAddSparePartCategoryButton({ onChange }) {
    const [showDialog, setShowDialog] = useState(false);
    const [create, { loading }] = useCreate('PMWorks/SparePartCategory');
        ...
        create(
            { payload: { data: values } },
            {
                onSuccess: ({ data }) => {
                    ...
                    form.change('SparePartCategoryID', data.id);
                    onChange();
                },
                onFailure: ({ error }) => {
    ...
    return (
        <>
            ...
            <Dialog
                ...
                aria-label="ایجاد خانواده قطعه"
            >
                <DialogTitle>ایجاد خانواده قطعه</DialogTitle>
...
export default QuickAddSparePartCategoryButton;
