...
const QuickSelectPersonnelButton = ({ id, setId, ...props }) => {
  ...
  return (
    <>
      ...
      <Dialog fullWidth open={showPanel} onClose={toggleDrawer}>
        <PersonnelList style={{width: '780px'}} {...props} resource="PMWorks/Personnel" setId={setId} setShowPanel={setShowPanel} />
      </Dialog>
    </>
  );
};

export default QuickSelectPersonnelButton;