...
const SelectButton = ({ selectedIds , setShowPanel, data }) =>{
    ...
    const toggleDrawer = () => {{selectedIds.map(selectedId => mutate({ type: 'create', resource: 'PMWorks/WOTask', payload: { data: {WorkOrderID: data.id, TaskID: selectedId, WOTaskSituationOfDo: 'ND'}} } )) }; onSuccess()};
